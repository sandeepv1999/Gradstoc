...
app.get(
  ...
  productController.myUploadedProducts
);
...
app.get(
  "/addBookmark/:id",
  CheckUser.isValidUser,
  productController.addToBookmark
);
...
app.post(
  ...
  CheckUser.isValidUser,
  productController.paypalTransaction
);

app.post(
  "/payment/direct-checkout",
  CheckUser.isValidUser,
  productController.walletTransaction
);
